...
public class AJAXController {
	...
	public Object myprofit(String id) {
	 ...
	 @RequestMapping("/insnewcust")
		public Object insnewcust(String id) {
			JSONObject result = new JSONObject();
			JSONArray ja = new JSONArray();
			JSONObject newcust = new JSONObject();
			JSONArray newcustja = new JSONArray();
			...
			try {
				...
				list = adminservice.insnewcust(id);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	 ...
	 @RequestMapping("/insgenderratio")
		public Object insgenderratio(String id) {
			JSONObject result = new JSONObject();
			JSONArray ja = new JSONArray();
			JSONObject male = new JSONObject();
			JSONObject female = new JSONObject();
